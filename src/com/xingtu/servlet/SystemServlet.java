...
import com.xingtu.service.impl.SystemServiceImpl;
...
public class SystemServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		} else if("toProductManagerView".equals(method)){ //到产品经理界面
			request.getRequestDispatcher("/WEB-INF/view/productManager/productManager.jsp").forward(request, response);
		}
	}
