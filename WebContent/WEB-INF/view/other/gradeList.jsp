	...
	$(function() {	
	        ...
	        columns: [[  
				...
				{field:'id', hidden:true},
 		        {field:'name',title:'年级名称',width:200},
 		       	{field:'createTime',title:'创建年月',width:200},
	    ...
	    $("#delete").click(function(){
        	...
        	if(selectRow == null){
            	...
            	$.messager.confirm("消息提醒", "将删除所选年级信息，确认继续？", function(r){
            		if(r){
            			$.ajax({
							type: "post",
							url: "GradeServlet?method=delete",
	    	...
	    	buttons: [
	    		{
					...
					handler:function(){
						...
						if(!validate){
							...
							$.ajax({
								type: "post",
								url: "GradeServlet?method=insert",
								...
								success: function(msg) {
									if (msg == "true") {
										...
										$("#add_name").textbox('setText', "");
										$("#create_time").datebox('setValue', "");
										$("#create_time").datebox('setText', "");
	    ...
	    $('#create_time').datebox({
	    	onSelect: function(date) {
	    		...
	    		var formatterDate = date.getFullYear() + "-" + month + "-" + day;
	    		$("#create_time").datebox('setValue', formatterDate);
				$("#create_time").datebox('setText', formatterDate);
				$("#create_time_value").val(formatterDate);
    	...
    	<form id="addForm" method="post">
	    	<table cellpadding="8" >
	    		...
	    		<tr>
	    			<td>创建日期:</td>
	    			<td>
	    				<input id="create_time" style="width: 200px; height: 30px;" class="easyui-datebox" data-options="required:true, missingMessage:'请选择日期'" />
	    				<input name="createTime" id="create_time_value" type="hidden"/>
	    			</td>
	    		</tr>
	    		<!-- <tr>
	    			<td>选择课程:</td>
